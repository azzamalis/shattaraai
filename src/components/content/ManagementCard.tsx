...
export function ManagementCard({
  ...
  return <div className="relative bg-dashboard-card rounded-xl p-6 border border-dashboard-separator/20 hover:border-dashboard-separator/40 transition-all" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
      <div className="flex items-start justify-between mb-6">
        ...
        {isHovered && <div className="flex items-center gap-2">
            <button onClick={onAddBelow} className="flex items-center gap-1 text-sm text-dashboard-text-secondary hover:text-dashboard-text transition-colors px-2 py-1 rounded-lg hover:bg-dashboard-bg">
            ...
            <button onClick={onDelete} className="text-dashboard-text-secondary hover:text-red-400 p-1 rounded-lg hover:bg-dashboard-bg transition-colors">
      ...
      <div className="space-y-6">
        ...
        {isExpanded && <div className="space-y-6 border-t border-dashboard-separator/20 pt-6">
            {card.hint && <div>
      ...
      <button onClick={onToggleExpansion} className="text-dashboard-text-secondary text-sm mt-6 hover:text-dashboard-text transition-colors font-medium">
