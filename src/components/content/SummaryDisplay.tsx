      ...
      return [
        ...
        },
        {
          ...
          summary: [
            ...
            'Applications include image recognition, speech synthesis, and autonomous vehicles'
          ],
          page: 41
        }
      ];
      ...
      return [
        {
          ...
          summary: [
            'Overview of the complete course structure and learning objectives',
            'Prerequisites and recommended background knowledge for students'
          ],
          timestamp: 150
        },
        {
          ...
          summary: [
            'Step-by-step guide to installing required software and tools',
            'Configuration of IDE and project structure setup'
          ],
          timestamp: 525
        },
        {
          ...
          summary: [
            'Writing and executing your first "Hello World" program',
            'Understanding basic syntax and common programming patterns'
          ],
          timestamp: 920
        }
      ];
      ...
      return [
        {
          ...
          summary: [
            'Welcome remarks and introduction of all participants',
            'Agenda overview and key discussion points to be covered'
          ],
          timestamp: 45
        },
        {
          ...
          summary: [
            'Current progress on deliverables and milestone achievements',
            'Challenges faced and proposed solutions for moving forward'
          ],
          timestamp: 312
        },
        {
          ...
          summary: [
            'Assignment of specific tasks to team members with deadlines',
            'Next meeting schedule and expected outcomes'
          ],
          timestamp: 750
        }
      ];
      ...
      return [
        {
          ...
          summary: [
            'Main topics and key concepts covered in this content',
    ...
    <div className="h-full p-4">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <ContentIcon className="h-5 w-5 text-dashboard-text-secondary dark:text-dashboard-text-secondary" />
        ...
        <Button
          ...
          className="border-border text-dashboard-text dark:text-dashboard-text hover:bg-accent hover:text-accent-foreground"
        >
      ...
      <div className="space-y-4">
        {summaryData.map((item) => (
          <div
            key={item.id}
            className="p-4 rounded-lg bg-dashboard-bg dark:bg-dashboard-bg border border-dashboard-separator/20 dark:border-white/10 hover:bg-dashboard-separator/5 dark:hover:bg-white/5 transition-colors"
          >
