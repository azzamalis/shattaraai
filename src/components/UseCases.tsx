...
const UseCases = () => {
  ...
  return (
    <section className="pt-12 md:pt-16 lg:pt-20 pb-8 md:pb-12 lg:pb-16 bg-background relative">
      <GradientBackground />
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div role="region" aria-label="Use Cases Carousel" className="relative">
          ...
          <div className="hidden md:block absolute top-1/2 -left-4 transform -translate-y-1/2 z-10">
            <button 
              onClick={scrollLeft} 
              className="p-3 rounded-full bg-[#00A3FF]/10 backdrop-blur-sm text-[#00A3FF] hover:bg-[#00A3FF]/20 hover:text-[#00A3FF] transition-colors border border-[#00A3FF]/20 shadow-[0_2px_8px_rgba(0,163,255,0.15)]" 
          ...
          >
            {useCases.map((useCase, index) => (
              <motion.div 
                ...
                className={cn(
                  "bg-card/50 backdrop-blur-sm border border-border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 focus:ring-2 focus:ring-primary/50", 
            ...
            {useCases.map((_, index) => (
              <button 
                ...
                className={cn(
                  ...
                  activeIndex === index ? "bg-[#00A3FF]" : "bg-[#00A3FF]/30"
                )} 
