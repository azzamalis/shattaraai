...
const Feature = ({
  ...
  return <div className={cn("flex flex-col lg:border-r py-10 relative group/feature border-[#2E2E2E]", (index === 0 || index === 3) && "lg:border-l border-[#2E2E2E]", index < 3 && "lg:border-b border-[#2E2E2E]")}>
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-[#2E2E2E] group-hover/feature:bg-primary transition-all duration-200 origin-center" />
