...
const AIChat = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col gap-2 p-4 border-t border-white/10 shrink-0">
        <div className="flex items-center gap-2">
          <Input
            ...
            className="flex-1 bg-transparent text-gray-200 border border-white/10 rounded-lg focus:border-white/20 focus:ring-0 focus:outline-none placeholder:text-gray-500 h-10"
          />
          <Button 
            variant="ghost" 
            size="icon"
            className="h-10 w-10 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg"
          >
          ...
          <Button 
            ...
            size="icon"
            className={cn(
              "h-10 w-10 hover:bg-white/5 rounded-lg",
          ...
          <Button 
            ...
            className="h-10 w-10 text-white hover:bg-white/5 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
