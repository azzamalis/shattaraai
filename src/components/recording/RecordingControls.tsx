...
export function RecordingControls({
  ...
  return <div className="w-full">
      <div className="flex items-center w-full bg-card border border-border rounded-xl px-3 py-3 min-h-[48px] gap-2">
        <Button 
          onClick={toggleRecording} 
          className={`h-10 px-4 flex items-center justify-center gap-2 border-border transition-all duration-300 text-sm font-medium shrink-0 ${
            isRecording 
