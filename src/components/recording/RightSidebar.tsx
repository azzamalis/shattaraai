  ...
  return (
    <div className="h-full flex flex-col bg-dashboard-bg">
      <Tabs defaultValue="chat" onValueChange={setActiveTab} className="flex-1 flex flex-col h-full">
        <div className="p-4 pb-3 border-b border-dashboard-separator bg-dashboard-bg">
          <TabsList className="w-full bg-dashboard-card border border-dashboard-separator shadow-sm rounded-lg p-1 h-11 grid grid-cols-5 gap-1">
            <TabsTrigger 
              value="chat" 
              className="h-9 rounded-md bg-transparent text-dashboard-text-secondary hover:text-dashboard-text data-[state=active]:bg-dashboard-bg data-[state=active]:text-dashboard-text data-[state=active]:shadow-sm transition-all duration-200 flex flex-col items-center justify-center gap-1"
            >
