  ...
  return <div className="w-[70%] max-w-md mx-auto py-8 px-6 flex flex-col items-center space-y-8">
      ...
      <div className="w-full rounded-xl p-4 space-y-3 bg-transparent border-white/10">
        <ToggleGroup type="single" value={questionFormat} onValueChange={value => value && setQuestionFormat(value)} className="flex justify-center gap-2 w-full">
          ...
          <ToggleGroupItem value="free-response" className="flex-1 bg-transparent data-[state=on]:bg-[#2A2A2A] border border-white/10 hover:bg-[#2A2A2A] text-white p-3 rounded-lg" aria-label="Free Response">
            <div className="flex items-center justify-center gap-2">
      ...
      <div className="w-full rounded-xl p-4 space-y-3 bg-transparent">
        <ToggleGroup type="single" value={difficulty} onValueChange={value => value && setDifficulty(value)} className="flex justify-center gap-2 w-full">
          <ToggleGroupItem value="easy" className="flex-1 bg-transparent data-[state=on]:bg-[#2A2A2A] border border-white/10 hover:bg-[#2A2A2A] text-white p-3 rounded-lg" aria-label="Easy">
            <div className="flex items-center justify-center gap-2">
          ...
          <ToggleGroupItem value="hard" className="flex-1 bg-transparent data-[state=on]:bg-[#2A2A2A] border border-white/10 hover:bg-[#2A2A2A] text-white p-3 rounded-lg" aria-label="Hard">
            <div className="flex items-center justify-center gap-2">
              <div className="flex">
                <Star className="h-5 w-5" />
                <Star className="h-5 w-5 -ml-2" />
      ...
      {/* Generate Button */}
      <button className="bg-white text-black py-3 px-8 font-medium rounded-lg w-full hover:bg-white/90 transition-colors">
        Generate
      </button>
    </div>;
};
