      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90" onClick={scrollToPositions}>
              View Open Positions
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-lg font-semibold text-foreground mb-1">Mission-Driven</div>
            ...
            <div className="text-center">
              ...
              <div className="text-lg font-semibold text-foreground mb-1">Fast Growth</div>
            ...
            <div className="text-center">
              ...
              <div className="text-lg font-semibold text-foreground mb-1">Great Culture</div>
