  ...
  return (
    <Popover open={menuOpen} onOpenChange={setMenuOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <MoreVertical className="w-3.5 h-3.5 opacity-100 xl:opacity-0 group-hover:opacity-100 text-accent-foreground hover:text-accent-foreground active:text-accent-foreground" />
        </div>
      </PopoverTrigger>
