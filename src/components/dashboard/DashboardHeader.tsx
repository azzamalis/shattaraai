      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <Dialog open={commandOpen} onOpenChange={setCommandOpen}>
            ...
            <Button variant="outline" className="bg-transparent border-border hover:text-primary hover:bg-primary/5 transition-all rounded-2xl py-5 h-9 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring px-[20px]">
                  ⌘K
                </Button>}
            </DialogTrigger>
