      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          {!isMobile && <Link to="/pricing">
              <Button variant="outline" className="bg-[#00A3FF]/5 border-2 border-[#00A3FF]/80 text-[#00A3FF] hover:text-[#00A3FF] hover:bg-[#00A3FF]/10 hover:border-[#00A3FF] transition-all py-5 h-9 shadow-[0_2px_8px_rgba(0,163,255,0.15)] hover:shadow-[0_4px_16px_rgba(0,163,255,0.25)] px-[21px] hover:shadow-[#00A3FF]/20 rounded-full">
                Upgrade
              </Button>
            </Link>}
          ...
          <Dialog open={commandOpen} onOpenChange={setCommandOpen}>
            ...
            <Button variant="outline" className="bg-transparent border-border hover:text-primary hover:bg-primary/5 transition-all h-9 px-[30px] text-base py-[20px] rounded-full">
                  ⌘K
                </Button>}
            </DialogTrigger>
