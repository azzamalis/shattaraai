          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-[#111] border border-zinc-800 p-0 max-w-[600px] text-white">
              ...
              <button 
                ...
                className="absolute right-4 top-4 p-1 rounded-full hover:bg-zinc-800 text-zinc-400 hover:text-white z-10"
              >
                <X size={20} />
              ...
              <div className="p-6 pt-5">
                ...
                {/* CTA button */}
                <Button 
                  className="mt-8 w-full h-12 bg-primary hover:bg-primary-light text-white font-medium text-base"
                >
                  Select Plan
                </Button>
