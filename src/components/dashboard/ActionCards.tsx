        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card onClick={handleUploadClick} className="bg-[#FDFDFD] border border-white/20 hover:border-white/40 hover:bg-white/5 transition-colors flex flex-col items-center p-4 md:p-6 text-center cursor-pointer group">
