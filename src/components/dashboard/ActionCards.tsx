      ...
      <div className="sm:justify-center sm:items-center gap-3 sm:flex grid grid-cols-1 w-full">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="border border-border text-card-foreground shadow-sm rounded-3xl group bg-card cursor-pointer transition-all duration-200 relative hover:shadow-md dark:hover:shadow-[0_0_8px_rgba(255,255,255,0.1)]" onClick={handleUploadClick}>
        ...
        <div className="flex-1 w-full sm:w-1/3">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="border border-border text-card-foreground shadow-sm rounded-3xl group bg-card cursor-pointer transition-all duration-200 relative hover:shadow-md dark:hover:shadow-[0_0_8px_rgba(255,255,255,0.1)]" onClick={onPasteClick}>
                  <div className="p-4 sm:h-28 flex flex-col sm:flex-col items-start justify-center gap-y-1">
                    <div className="flex items-center gap-x-3 sm:block">
        ...
        <div className="flex-1 w-full sm:w-1/3">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="border border-border text-card-foreground shadow-sm rounded-3xl group bg-card cursor-pointer transition-all duration-200 relative hover:shadow-md dark:hover:shadow-[0_0_8px_rgba(255,255,255,0.1)]" onClick={handleRecordClick}>
                  <div className="p-4 sm:h-28 flex flex-col sm:flex-col items-start justify-center gap-y-1">
                    <div className="flex items-center gap-x-3 sm:block">
