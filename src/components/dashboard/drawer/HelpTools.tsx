  ...
  return (
    <div className="px-4 py-2">
      ...
      <div className="space-y-1">
        <Button variant="ghost" className="w-full justify-start text-white hover:bg-white/5 hover:text-white transition-colors duration-200" onClick={onTutorialClick}>
          <Book size={18} className="mr-2" />
          <span>Tutorial</span>
        </Button>
        <Button variant="ghost" className="w-full justify-start text-white hover:bg-white/5 hover:text-white transition-colors duration-200" onClick={onFeedbackClick}>
