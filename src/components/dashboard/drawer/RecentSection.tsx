...
export const RecentSection: React.FC<RecentSectionProps> = ({ rooms }) => {
  ...
  const { recentContent, onDeleteContent } = useContent();
                ...
                <div key={item.id} className="group flex items-center justify-between gap-2 px-2 py-1 rounded-lg hover:bg-primary/5 transition-colors">
                  ...
                  >
                    <Link 
                      ...
                      className="flex items-center gap-2 min-w-0 text-primary/80 hover:text-primary transition-colors"
                    >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent 
                      ...
                      align="start" 
                      alignOffset={-5}
                      className="w-[160px] bg-popover border-border z-50"
                    >
                      <DropdownMenuSub>
                        ...
                        <DropdownMenuSubContent 
                          className="w-[160px] bg-popover border-border z-[60]"
                          alignOffset={-5}
                          sideOffset={8}
                        >
                      ...
                      <DropdownMenuItem
                        ...
                        className="flex items-center px-2 py-1.5 text-sm cursor-pointer hover:bg-accent hover:text-accent-foreground transition-colors focus:bg-accent focus:text-accent-foreground rounded-sm text-destructive focus:text-destructive"
                      >
