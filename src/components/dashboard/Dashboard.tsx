...
import { 
  BookOpen, FileText, Plus, Search, Upload, Send, Mic, Box, ChevronDown,
  FileIcon, LinkIcon, MicIcon, Trash2, X, MessageSquare,
  MoreVertical, Pencil, Check, Share, Copy, Globe
} from 'lucide-react';
          ...
          <div className="mb-4 sm:mb-6 md:mb-8 flex justify-center">
            <Popover>
              <PopoverTrigger asChild>
                <Button 
                  className="bg-transparent hover:bg-white/5 text-white px-4 py-2 rounded-full flex items-center gap-2 border border-white/20"
                >
              ...
              <PopoverContent 
                className="w-[200px] bg-[#1A1A1A] border border-white/10 text-white p-0" 
                align="center" 
                sideOffset={5}
              >
                <div className="py-2 px-1">
                  ...
                  <Button 
                    variant="ghost" 
                    className="w-full justify-start px-2 py-1.5 text-sm text-white hover:bg-primary/10 hover:!text-white group"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8 md:mb-12">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent 
                  className="bg-[#1A1A1A] border border-white/10 text-white px-3 py-2 text-sm rounded-lg shadow-xl"
                  sideOffset={5}
                >
                ...
                <div className="p-3">
                  ...
                  <div className="bg-white rounded-xl w-full mb-3 relative">
                    ...
                    <Popover open={menuOpen} onOpenChange={setMenuOpen}>
                      <PopoverTrigger asChild>
                        <button 
                          onClick={(e) => handleMenuClick(e, 'python-card')}
                      ...
                      <PopoverContent 
                        className="w-[140px] bg-black/90 rounded-lg border-none p-1" 
                        align="end"
                        sideOffset={5}
                      >
                        <div className="flex flex-col">
                          <Button
                            variant="ghost"
                            className="w-full justify-start text-white hover:bg-primary/10 hover:text-white rounded-md px-3 py-2 text-sm font-normal"
                            onClick={handleShare}
                          >
