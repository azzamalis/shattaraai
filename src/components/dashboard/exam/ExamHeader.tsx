...
export function ExamHeader({
  ...
  return <header className="sticky top-0 z-10 border-b border-border bg-card">
      <div className="flex items-center justify-between px-6 py-[18px]">
        ...
        <div className={cn("font-mono text-lg", timeRemaining < 300 ? "text-red-500" : "text-foreground")}>
