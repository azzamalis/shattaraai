          ...
          <div className="bg-card rounded-xl p-8 border border-border space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.3. Agreement</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.4. Parties</h3>
                  <p className="text-muted-foreground leading-relaxed">Both of us – we, Shattara, and you, the Customer.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.5. Effective date</h3>
                  <p className="text-muted-foreground leading-relaxed">Refer to the moment when the Agreement becomes valid between the Parties.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.6. Subscription</h3>
                  <p className="text-muted-foreground leading-relaxed">A Service provided to the Paid Customer on a recurring basis under Order Confirmation.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.7. Platform</h3>
                  <p className="text-muted-foreground leading-relaxed">The online learning support system provided by Shattara. Referred to as "The Platform" or "The Service".</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.8. Associated documents</h3>
                  <p className="text-muted-foreground leading-relaxed">Documents referred in this Agreement or that are published at shattara.com</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.9. Term</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">1.10. Shattara Account</h3>
                  <p className="text-muted-foreground leading-relaxed">Password protected user-account created on shattara.com</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">2. The Shattara Platform</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">2.1. Your Shattara account</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">2.2. Membership and payment</h3>
                  
                  <div className="ml-4 space-y-4">
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.2.1. Acceptance</h4>
                      <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.2.2. Payment</h4>
                      <div className="ml-4 space-y-3">
                        <div>
                          <h5 className="text-base font-medium text-foreground mb-1">2.2.2.1. General</h5>
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.2.3. Activation (delivery)</h4>
                      <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.2.4. Withdrawal</h4>
                      <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">2.3. Duration, renewal and termination</h3>
                  
                  <div className="ml-4 space-y-4">
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.3.1. Duration</h4>
                      <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.3.2. Automatic renewal</h4>
                      <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.3.3. Changes</h4>
                      <p className="text-muted-foreground leading-relaxed mb-3">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.3.4. Termination</h4>
                      <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.3.5. Free Access</h4>
                      <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">2.4. Using the Platform</h3>
                  
                  <div className="ml-4 space-y-4">
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.4.1. Requirements of the customer</h4>
                      <p className="text-muted-foreground leading-relaxed mb-3">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.4.2. Uploaded content/input</h4>
                      <p className="text-muted-foreground leading-relaxed mb-3">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-foreground mb-2">2.4.3. Obligations of the Customer</h4>
                      <p className="text-muted-foreground leading-relaxed mb-3">
                      ...
                      <ul className="list-disc list-inside text-muted-foreground ml-4 space-y-1 mb-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">2.5. Performance guarantee</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">3. Service level</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <p className="text-muted-foreground leading-relaxed mb-2">The following circumstances are excluded from the Uptime:</p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-3">3.1. Downtime</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">4. Data and ownership</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">5. Other</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">6. Limited liability</h2>
              <p className="text-muted-foreground leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">7. Governing Law and Dispute Resolution</h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">7.1. Before Dispute arises</h3>
                  <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3 font-normal">Before any formal actions or legal proceedings, the Customer shall contact Shattara's support at hello@shattaraai.com. The message shall provide a brief written description and include contact details.</p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">7.2. Governing Law</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-3">7.3. Dispute resolution</h3>
                  <p className="text-muted-foreground leading-relaxed">
