      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-20">
          ...
          <div className="bg-card p-8 rounded-xl border border-border">
            ...
            <h3 className="text-xl font-semibold mb-4 text-foreground">Instant Study Materials</h3>
          ...
          <div className="bg-card p-8 rounded-xl border border-border">
            ...
            <h3 className="text-xl font-semibold mb-4 text-foreground">Adaptive Learning Paths</h3>
            <p className="text-muted-foreground">
          ...
          <div className="bg-card p-8 rounded-xl border border-border">
            ...
            <h3 className="text-xl font-semibold mb-4 text-foreground">Insightful Analytics</h3>
            <p className="text-muted-foreground">
          ...
          <div className="bg-card p-8 rounded-xl border border-border">
            ...
            <h3 className="text-xl font-semibold mb-4 text-foreground">Time-Saving Automation</h3>
            <p className="text-muted-foreground">
          ...
          <div className="bg-card p-8 rounded-xl border border-border">
            ...
            <h3 className="text-xl font-semibold mb-4 text-foreground">Professional Development</h3>
            <p className="text-muted-foreground">
